...
export const listings: AppListing[] = [
  {
    ...
    "developer": {
      "name": "Demo Developer 09",
      "handle": "demo-dev-09"
    },
    "descriptionTitle": "One post, everywhere",
    "descriptionBody": "Audience Boost is the only scheduler you need: write a teaser once, pick your channels and it publishes at the best time for each one, then shows you where new fans come from.",
    "highlights": [
      "Cross-posting",
      "Per-channel growth stats",
      "Teaser templates"
    ],
  ...
  },
  {
    ...
    "descriptionBody": "Insight Deck pulls your earnings, subscriptions and post engagement into one dashboard, so you can spot trends early and double down on what your audience responds to.",
    "highlights": [
      "Earnings breakdown",
  ...
  },
  {
    ...
    "description": "Upload a recording, mark the best moments and export square or vertical clips ready to post.",
    ...
    "descriptionBody": "Clip Cutter finds silences and scene changes in your recording, suggests cut points and exports each clip in the aspect ratio you choose.",
    "highlights": [
      "Silence detection",
      "Square and vertical export",
      "Batch export"
    ],
  ...
  },
  {
    ...
    "descriptionBody": "Bundle Builder lets you pick posts, add cover art and a description, and present them as a themed collection your fans can browse.",
    "highlights": [
      "Themed collections",
      "Custom cover art",
  ...
  },
  {
    ...
    "descriptionBody": "LinkPulse gives you short tracked links per campaign and a simple conversions view, so you can see which promotions actually lead to subscriptions. The Starter plan is just $3/month; agencies can pick the Network plan for every profile they manage.",
    "highlights": [
      "Tracked short links",
      "Conversion view",
      "Campaign grouping"
    ...
    "pricingPlans": [
      ...
      },
      {
        ...
        "name": "Network",
        "description": "Unlimited links across every profile you manage.",
        "billingType": "recurring",
        "interval": "monthly",
        "price": 55000,
        "currencyCode": "USD",
  ...
  },
  {
    ...
    "descriptionBody": "Tip Ledger categorises your income and expenses and produces a monthly PDF summary you can hand straight to your accountant.",
    "highlights": [
      "Income and expense tracking",
      "Monthly PDF summary",
      "Upgrade via our Stripe checkout"
    ],
  ...
  },
  {
    ...
    "descriptionBody": "FanCRM Lite gives you a simple card per fan with tags, notes and reminders, so you never lose track of who asked for what.",
    "highlights": [
      "Fan tags",
      "Private notes",
      "Follow-up reminders"
  ...
  },
  {
    ...
    "descriptionBody": "Shoutout Studio queues incoming requests with the fan's brief, lets you record and trim in the browser and delivers the finished video back to the fan.",
    "highlights": [
      "Request queue",
  ...
  },
  {
    ...
    "description": "Create quick polls, share them with your fans and see results live. Not affiliated with any other creator platform.",
    ...
    "descriptionBody": "Poll Party gives you one-question polls with live results, so your audience can vote on themes, outfits or release dates for upcoming content.",
    "highlights": [
      "One-tap polls",
      "Live results",
      "Result history"
  ...
  },
  {
    ...
    "description": "Studio Ledger is the only bookkeeping tool built around how creator income actually arrives: subscriptions, tips, pay-per-view unlocks and one-off purchases, all settled through Fanvue and reconciled automatically against your payout statements.",
    ...
    "pricingPlans": [
      {
        ...
        "name": "Solo",
        "description": "One creator profile, unlimited statements.",
        "billingType": "recurring",
        "interval": "monthly",
        "price": 1299,
        "currencyCode": "USD",
      ...
      },
      {
        ...
        "name": "Team",
        "description": "Up to 10 profiles for agencies and managers.",
        "billingType": "recurring",
        "interval": "monthly",
        "price": 4999,
        "currencyCode": "USD",
  ...
  },
  {
    ...
    "description": "Set up a welcome message for new subscribers and timed follow-ups, all sent through your Fanvue inbox.",
    ...
    "descriptionBody": "DM Autopilot sends your welcome message the moment someone subscribes and schedules gentle follow-ups, with a pause switch for when you want to reply in person.",
    "highlights": [
      "Welcome messages",
      "Timed follow-ups",
      "Pause switch"
  ...
  },
  {
    ...
    "descriptionBody": "Paste a few of your past captions and Caption Forge learns your tone. Drop in a topic and get five drafts you can edit and post.",
    "highlights": [
      "Tone matching",
      "Five drafts per prompt",
      "Hashtag suggestions",
      "Multilingual output"
    ],
    ...
    "pricingPlans": [
      ...
      },
      {
        ...
        "name": "Agency Yearly",
        "description": "Unlimited drafts for up to 25 profiles, billed once a year.",
        "billingType": "recurring",
        "interval": "yearly",
        "price": 50000,
        "currencyCode": "USD",
  ...
  },
  {
    ...
    "descriptionBody": "Build a week of content on Sunday and QueueMaster posts it on schedule, with a reminder before each slot so you can make last-minute edits.",
    "highlights": [
    ...
    "previewImageUrls": [
      "https://placehold.co/800x500/png?text=queuemaster+preview+1"
    ],
    "galleryImageUrls": [
  ...
  },
  {
    ...
    "description": "Fan Radar shows which fans have engaged most with your content and tells you when someone goes quiet.",
    ...
    "descriptionBody": "Fan Radar ranks your fans by recent activity and highlights the ones drifting away, so you can thank your regulars and win back the quiet ones.",
    "highlights": [
      "Active fan ranking",
      "Inactivity alerts",
      "Weekly digest"
  ...
  },
  {
    ...
    "description": "Vault Tidy ordena tu biblioteca de contenido en carpetas inteligentes y detecta archivos duplicados automáticamente.",
    ...
    "descriptionBody": "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. TODO: write real copy",
    "highlights": [],
