...
> What your app needs to be approved for the Fanvue App Store, and to stay listed. Each rule is numbered so review feedback can cite the exact section.

These guidelines explain what your app needs in order to be approved for the Fanvue App Store, and what you'll need to maintain after launch to stay listed.

Our goal is to make the review process predictable and transparent. Every app is reviewed against the same requirements, so you'll always know what we're looking for and what needs to change if your submission isn't ready yet.

If your app doesn't meet one or more of these requirements, we'll reference the relevant section below as part of our review feedback. Once you've addressed the feedback, you're welcome to resubmit.

Before you submit, make sure you've checked:
...
Everything a user can see before they open your app must be safe for work. This covers your:
...
These surfaces are shown to every creator and fan browsing the store, before anyone has chosen to open your app, and regardless of the content that creator produces. They must never contain explicit, adult, or sexually suggestive material.
...
**Use instead.** Show the product doing its job: the real interface, dashboards, workflows, and outputs. Where a person appears (for example in a creator profile or a generated image), they must be fully clothed in everyday attire and shown in a non-sexual context.

This rule governs the listing surface only. It does not restrict what your app does for creators in-product, which is covered separately under 1.2 and Fanvue's content policies.
...
The safe-for-work bar in 1.1 applies to existing listings as well as new submissions. We will re-review current listings against it and ask for updated assets where needed; listings that are not corrected promptly may be suspended or delisted.
